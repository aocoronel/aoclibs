...
#define generate_header_map(TYPE, VALUE_TYPE, PREFIX)                             \
    AOCDEF void PREFIX##_insert(Arena *arena, TYPE *m, Slice *s, VALUE_TYPE key); \
...
#define generate_definition_map(TYPE, VALUE_TYPE, PREFIX)                                     \
    int _##PREFIX##_bs(TYPE *m, unsigned char k) {                                            \
        ...
        return left;                                                                          \
                                                                                              ...
                                                                                              \
    void _##PREFIX##_insert(Arena *arena, TYPE *m, Slice *s, VALUE_TYPE key, size_t cursor) { \
        if (cursor == s->len) {                                                               \
            if (m->occupied == true) return NULL;                                             \
            m->occupied = true;                                                               \
            m->value = key;                                                                   \
            return;                                                                           \
        }                                                                                     \
        ...
        _##PREFIX##_insert(arena, &m->data[left], s, key, cursor + 1);                        \
                                                                                              ...
                                                                                              \
    void PREFIX##_insert(Arena *arena, TYPE *m, Slice *s, VALUE_TYPE key) {                   \
