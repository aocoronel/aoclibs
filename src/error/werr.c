...
edouble werr_double(Err err, double value)  { return (edouble){err, value}; }
efloat  werr_float(Err err, float value)    { return (efloat){err, value}; }
eint    werr_int(Err err, int value)        { return (eint){err, value}; }
elong   werr_long(Err err, long value)       { return (elong){err, value}; }
elonglong werr_longlong(Err err, long long value) { return (elonglong){err, value}; }
eshort  werr_short(Err err, short value)     { return (eshort){err, value}; }
